...
Revision ID: cc0b47378dd4
Revises: 61c69a501267
Create Date: 2026-07-29 14:11:38.057371
...
revision: str = 'cc0b47378dd4'
down_revision: Union[str, Sequence[str], None] = '61c69a501267'
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('acessorio', schema=None) as batch_op:
        batch_op.add_column(sa.Column('valor_mensal', app.models.tipos.DecimalText(), nullable=True))
